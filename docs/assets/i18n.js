const WISP_PAGES_I18N = {
  zh: {
    ...
    "meta.skills.desc": "了解 Wisp Science 的 27 个内置技能：文献与证据、数据分析、图表与写作、计算环境和自动化。",
    "skills.categories": "技能分类",
    "meta.home.title": "Wisp Science | 开源科学计算 Agent",
    "meta.home.desc":
      "Wisp Science 是开源、本地优先的科研工作台，支持 Windows、macOS 和 Linux。连接模型服务，运行 Python／R，使用科研数据库与 27 个内置技能，让分析过程有据可查。",
    ...
    "faq.a2":
      "它围绕项目组织文件、会话、工具与执行记录，可以运行 Python／R、检索科研数据库，并保存分析产物。27 个内置技能提供可复用的方法与检查步骤。",
    "faq.q3": "数据会保存在哪里？",
    "faq.a3":
  ...
  en: {
    ...
    "meta.skills.desc": "Explore Wisp Science’s 27 bundled Skills for literature, analysis, figures, writing, compute environments, and automation.",
    "skills.categories": "Skill categories",
    "meta.home.title": "Wisp Science | Open-source scientific computing agent",
    "meta.home.desc":
      "Wisp Science — an open-source, local-first scientific agent workbench for Windows, macOS, and Linux. Bring your own LLM, run Python / R, and call 80+ scientific databases plus 27 bundled SKILLs.",
    ...
    "features.skillTitle": "27 bundled SKILL workflows",
    "features.skillBody":
    ...
    "stack.skill": "27 bundled workflows",
    ...
    "faq.a2":
      "It actually executes: read and write local files, run a shell, call persistent Python / R REPLs, query PubMed/UniProt through MCP, and store the full session in SQLite. It ships 27 domain SKILLs instead of only generating text.",
